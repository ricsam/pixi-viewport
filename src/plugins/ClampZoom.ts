  ...
  public clamp(): void {
    ...
    if (
      ...
      if (typeof this.options.minScale === "number") {
        ...
        minScale.x =
          typeof optsMinScale.x === "undefined" ? null : optsMinScale.x;
        minScale.y =
          typeof optsMinScale.y === "undefined" ? null : optsMinScale.y;
      }
      ...
      if (typeof this.options.maxScale === "number") {
        ...
        maxScale.x =
          typeof optsMaxScale.x === "undefined" ? null : optsMaxScale.x;
        maxScale.y =
          typeof optsMaxScale.y === "undefined" ? null : optsMaxScale.y;
      }
