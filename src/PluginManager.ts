...
export class PluginManager {
  ...
  public add(
    name: string,
    plugin: Plugin,
    index: number = PLUGIN_ORDER.length,
  ) {
  ...
  public get(
    name: "clamp-zoom",
    ignorePaused?: boolean,
  ): ClampZoom | undefined | null;
  public get(
    name: "decelerate",
    ignorePaused?: boolean,
  ): Decelerate | undefined | null;
